...
var ChannelService = class ChannelService {
    ...
    _initUdpListener() {
        ...
        try {
            ...
            this._udp6_source.set_callback(this._onIncomingIdentity.bind(this));
        ...
        try {
            ...
            this._udp4_source.set_callback(this._onIncomingIdentity.bind(this));
    ...
    _onIncomingIdentity(socket, condition) {
